        ...
        <div className="mt-10">
          ...
          >
            <button
              ...
              className={cn(
                'inline-flex flex-1 sm:flex-none items-center justify-center rounded-lg px-4 py-2 text-sm font-medium min-w-0 sm:min-w-[13rem] max-w-full text-center whitespace-nowrap border border-transparent transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2',
                activeTab === 'individuals'
                  ? 'bg-[#1D4ED8] text-white'
                  : 'bg-[#EFF6FF] text-slate-900 border border-slate-300 hover:bg-[#EFF6FF]',
              )}
            >
              Частные клиенты
            </button>
