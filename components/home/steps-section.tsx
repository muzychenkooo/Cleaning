  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="mt-10 sm:mt-14 grid gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 items-stretch">
          {steps.map((step, index) => (
            ...
            >
              <div className="relative h-full rounded-2xl border border-slate-200 bg-white px-4 py-4 sm:px-7 sm:py-7 shadow-sm transition-all duration-200 hover:shadow-lg hover:shadow-slate-200/50 hover:-translate-y-1 motion-reduce:translate-y-0 flex flex-col">
              <span
                  ...
                  <>
                    ...
                    <a
                      ...
                      onClick={(event) => {
                        ...
                        const target = document.getElementById('contact-questions');
                        if (!target) return;
