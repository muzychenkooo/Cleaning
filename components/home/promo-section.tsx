...
export function PromoSection() {
  ...
  return (
    <section className="w-full py-16 sm:py-24 bg-[var(--brand-primary-dark)] text-white flex items-center min-h-[260px] sm:min-h-[300px]">
      <Container>
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.2fr)] items-center">
          <div className="w-full min-w-0 max-w-full self-center lg:max-w-2xl">
            <h2 id="special-offer" className="font-display text-2xl font-bold sm:text-3xl">
              {promo.title}
            </h2>
