...
export function Footer() {
  ...
  return (
    <footer className="w-full min-w-0 overflow-x-clip border-t border-slate-200 bg-slate-50">
      <Container className="pt-14 pb-24 sm:py-16">
        {/* 4 columns on desktop, 2x2 grid on mobile/tablet */}
        <div className="grid min-w-0 grid-cols-2 gap-10 xl:grid-cols-4">
          ...
          <div className="order-2 min-w-0 xl:order-4">
            ...
            <ul className="mt-2 space-y-1.5">
              ...
              <li className="min-w-0 break-words">
                <a
                  ...
                  className="text-sm text-slate-600 hover:text-primary-600 no-underline break-words"
                >
