...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-full 2xl:max-w-[1440px] flex-col gap-4 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:px-6 lg:px-8">
