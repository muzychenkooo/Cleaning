...
// @ts-ignore - react-hook-form conditional "react-server" export; runtime has useForm
...
export function QuizWizard({ onSuccessClose }: QuizWizardProps = {}) {
  ...
  return (
    <div className="mx-auto w-full min-w-0 max-w-full xl:max-w-[1280px] px-4 sm:px-6 lg:px-8">
      <div className="lg:grid lg:min-w-0 lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-12">
